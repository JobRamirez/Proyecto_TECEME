...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: MapExplorerWidget.routeName,
          path: MapExplorerWidget.routePath,
          builder: (context, params) => MapExplorerWidget(),
        ),
        FFRoute(
          name: ARPreviewPlaceholderWidget.routeName,
          path: ARPreviewPlaceholderWidget.routePath,
          builder: (context, params) => ARPreviewPlaceholderWidget(),
        ),
        FFRoute(
